    ...
    yield* Effect.acquireUseRelease(
      ...
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "Cut2Kit",
          GIT_AUTHOR_EMAIL: "cut2kit@users.noreply.github.com",
          GIT_COMMITTER_NAME: "Cut2Kit",
          GIT_COMMITTER_EMAIL: "cut2kit@users.noreply.github.com",
        };
